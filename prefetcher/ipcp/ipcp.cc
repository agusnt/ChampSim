...
IP_TABLE_L1 trackers_l1[1][NUM_IP_TABLE_L1_ENTRIES];
DELTA_PRED_TABLE DPT_l1[1][4096];
uint64_t ghb_l1[1][NUM_GHB_ENTRIES];
uint64_t prev_cpu_cycle[1];
uint64_t num_misses[1];
float mpkc[1] = {0};
int spec_nl[1] = {0};
